export const EMAIL_THEMES = [
  ...
  },
  {
    id: 'line-puppy',
    name: '线条小狗日记',
    description: '软乎乎的奶油黄和小狗脚印，适合每天写一句喜欢。',
    emoji: '🐶',
    accent: '#8B5E3C',
    background: '#FFF6D9',
    unlockDays: 2,
  },
  {
    id: 'lulu',
    name: '噜噜软糖',
    description: '葡萄紫配薄荷绿，把两个人的好心情装进一颗软糖。',
    emoji: '🍬',
    accent: '#7656A8',
    background: '#F3EEFF',
    unlockDays: 7,
  },
  {
    id: 'nailong',
    name: '奶龙抱抱',
    description: '奶黄色的小太阳和圆滚滚的拥抱，给坚持一点奖励。',
    emoji: '🐲',
    accent: '#9A641A',
    background: '#FFF4C7',
    unlockDays: 14,
  },
  {
    id: 'yibubu',
    name: '一二布布乐园',
    description: '蓝莓蓝和莓果红的轻快配色，记录你们一起完成的小事。',
    emoji: '🧸',
    accent: '#3C639B',
    background: '#EAF2FF',
    unlockDays: 21,
  },
  {
    id: 'tom-jerry',
    name: '猫鼠追光',
    description: '俏皮的奶酪黄和夜蓝色，今天也一起追到小小的快乐。',
    emoji: '🐱🐭',
    accent: '#A45A20',
    background: '#FFF1D6',
    unlockDays: 30,
...
const palettes: Record<EmailTheme, Palette> = {
  ...
  'line-puppy': {
    ...
    ornament: '🐾   ♡   🐾',
    ornamentSize: 25,
    edge: '6px solid #B8844F',
    label: '小狗日记 · 今天也一起完成',
    note: '把每一件小事，写成一颗软乎乎的心。',
  },
  lulu: {
    card: '#FFFDFF',
    header: '#E7DDF8',
    ...
    ornament: '✦   🍬   ✦',
    ornamentSize: 25,
    edge: '5px dotted #9777C8',
    label: '噜噜软糖 · 甜甜的来信',
    note: '把好心情分你一半，剩下的一半留给明天。',
  },
  nailong: {
    card: '#FFFDF3',
    header: '#FFE89A',
    ...
    ornament: '☀   🐲   ☀',
    ornamentSize: 25,
    edge: '7px solid #D19B39',
    label: '奶龙抱抱 · 给坚持的奖励',
    note: '今天也有好好对待彼此，抱一下再出发。',
  },
  yibubu: {
    card: '#FFFFFF',
    header: '#DCEAFF',
    ...
    ornament: '☁   🧸   ☁',
    ornamentSize: 25,
    edge: '5px dashed #789ED0',
    label: '一二布布乐园 · 一起长大',
    note: '每一次并肩完成，都是你们的小小勋章。',
  },
  'tom-jerry': {
    card: '#FFFEF8',
    header: '#FFE2A3',
    ...
    ornament: '🐾   🧀   🐾',
    ornamentSize: 25,
    edge: '6px double #C88739',
    label: '猫鼠追光 · 快乐刚刚好',
    note: '你追我赶没关系，记得最后一起笑。',
  },
};
